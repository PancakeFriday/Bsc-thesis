...
Although the shifting gradient is not visible in the final picture, since it is removed by subtracting the background image, it is still important to minimalize the noise originating from shifting the charges, which was found to be the case for minimal readout speed, see \refFig{hvspeed}.
...
\draftA[-8,28]{slit_scheme}{}{}
\pltB[1.6,-2.75]{slit_dist}{Distance dependant diffraction}{
