...
The cloud was imaged using the new imaging system, yielding the results in \refFig{fermi_fit}. The atoms can be seen as a cloud which is larger in x than in y direction, which is due to the geometry of the optical dipole trap.
