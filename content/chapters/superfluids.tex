...
When the atoms are in the degenerate regime, a gaussian fit should diverge for smaller $T/T_F$. Therefore a gaussian distribution was also fitted to the fermi gas. The $\chi^2$ of both fits was investigated and we found the relative values to be $\chi_{Fermi} / \chi_{Gauss} = \{0.85, 0.87, 0.76\}$. From this we can conclude, that the Li atoms are in the degenerate regime, although they can still be explained by a gaussian.
...
\begin{table}
	\begin{center}
		\begin{tabular}{M{1.5cm}!M{4cm}|M{4cm}|M{4cm}N}
			...
			\hline
			$T/T_F$ & $0.34\pm0.03$ & $0.42\pm0.04$ & $1.01\pm0.41$ & \\[7pt]
			\hline
			$T_{tof} [\SI{}{\nano\kelvin}]$ & $56$ & $97$ & $480$ & \\[7pt]
			\hline
			$N_{side}$ & $56$ & $97$ & $480$ & \\[7pt]
			\hline
			$N_{calc}$ & $56$ & $97$ & $480$ & \\[7pt]
		\end{tabular}
	\end{center}
