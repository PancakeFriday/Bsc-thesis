...
\begin{tabular}{|l|l|}
	...
	\hline
\end{tabular}
\setCaption{Trigger timing}{The trigger signals are limited by the readout speeds of the chip. This table lists the minimal timings necessary to fully read out the chip. Between signal 4 and 5, the illuminated pixels are still shifted downwards, before the chip is read out. This prevents introducing unnecessary errors, as all relevant pixels are then behind the cover of the slit.}
